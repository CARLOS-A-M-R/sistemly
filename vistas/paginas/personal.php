			...
			<div class="row ">
				<div class="panel-body table-responsive" id="listadoregistros">
                    ...
                    <form name="formulario" id="formulario" method="POST">
                        <fieldset>
                        <legend align="center"><i class="fa fa-user" aria-hidden="true"></i> Informacion Personal</legend>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="domicilioRegistro" id="domicilio" maxlength="50" placeholder="Domicilio" >
                          </div>
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="telefonoRegistro" id="telefono" maxlength="50" placeholder="Telefono" >
                          </div>

                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Email:</label>
                            <input type="text" class="form-control" name="emailRegistro" id="email" maxlength="50" placeholder="Correo email" >
                          </div>

                          <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                            <label>Edad:</label>
                            <input type="text" class="form-control" name="edadRegistro" id="edad" maxlength="50" placeholder="Edad" >
                          </div>
