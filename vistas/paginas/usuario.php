	...
	<div class="container-fluid ">
		<div class="page-header ">
			<h4 class="box-title">Cuentas de Usuarios <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h4>
                    ...
                    <form name="formulario" id="formulario" method="POST">
                        ...
                        <legend align="center"><i class="fa fa-user" aria-hidden="true"></i> Informacion de la nueva Cuenta</legend>
                          ...
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              ...
                              <select id="usuario" name="usuarioCuenta" class="form-control selectpicker" data-live-search="true" required></select>  
                          </div>   
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="claveCuenta" id="clave" maxlength="50" placeholder="Clave Cuenta" required>
                          </div>
