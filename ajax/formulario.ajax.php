    ...
    switch ($key) {
        ...
        case 'guardaryeditar':
            ...
            {    
                ...
                echo $respuesta ? "Personal registrado" : "Personal no se pudo registrado";
             }else{
        ...
        case 'filtrar':
            ...
            echo '<option value="0">Seleccion usuario</option>';
        ...
        case 'guardaryactualizar':
                ...
                if(empty($usuario))
                {    
                    $respuesta = $prueba->ctrRegistroCuentas($permiso);
                    ...
                    $respuesta = $prueba->ctrActualizarCuentas($permiso);
