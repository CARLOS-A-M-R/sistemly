...
class ModeloFormularios
{
     ...
     /*===========================================================* 
     Mostrar contenido de sistemly
     =============================================================*/
     static public function mdlMostrarSistemly($tabla)
     {
     ...
     static public function mdlMostrarUsuarios($tabla,$item,$valor)
     {
          ...
          if($item == null && $valor == null)
          {
               ...
               $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE $item = :$item AND tcu_estado = '1' ORDER BY tcu_cod_cuenta DESC");
     ...
     static public function mdlRegistroCuentas($tabla,$datos,$tabla2,$permisos)
     {
          ...
          $stmt = $respuesta->pdo->prepare("INSERT INTO $tabla(tcu_cod_personal,tcu_nombre_cuenta,tcu_clave_cuenta,tcu_nivel_usuario) VALUES (:tcu_cod_personal,:tcu_nombre_cuenta,:tcu_clave_cuenta,:tcu_nivel_usuario)");
